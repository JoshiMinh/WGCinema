...
public class MovieList extends JFrame {
    ...
    // Setup the top bar with title and logo
    ...
    // Setup the movie panel with a scrollable grid layout
    ...
    // Load movie list from the database
    ...
    private JPanel createMoviePanel(int movieId, String imageLink, String title, String rating) throws java.net.MalformedURLException {
        ...
        JLabel imageLabel = new JLabel(new ImageIcon(new ImageIcon(new URL(imageLink))
                .getImage().getScaledInstance(180, 270, Image.SCALE_SMOOTH)));
    ...
    // Create a title panel with movie title and age rating
