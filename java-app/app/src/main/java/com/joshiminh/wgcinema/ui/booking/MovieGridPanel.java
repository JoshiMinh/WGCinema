...
public class MovieGridPanel extends JFrame {
    ...
    public MovieGridPanel(String url, String email) {
        this.url = url;
        this.email = email;
        initializeFrame();
        setupComponents();
    ...
    private void performSearch() {
        ...
        if (query.isEmpty()) {
            resultSet = MovieDAO.fetchUpcomingMovies(url);
        } else {
            resultSet = MovieDAO.searchMoviesByTitle(url, query);
        }
        ...
        card.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getSource() == card && e.getComponent() != bookButton && !SwingUtilities.isDescendingFrom(e.getComponent(), bookButton)) {
                    new MovieDetailPanel(movieId, url);
                }
            }
            @Override
            public void mouseEntered(MouseEvent e) {
